...
if (!is_user_logged_in()) {
	...
	$user_sale_query = new WP_User_Query( $args );
		...
		if ( isset( $_REQUEST['pid'] ) ) {
			...
			$agencyname = get_the_title($post_id);
				 ...
				 <form id="addagency" action="" method="POST">
				  <div class="card-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="agencyname" name="agencyname" placeholder="Enter name" <?php if ( $mode == 'EDIT') { echo 'value="'.$agencyname.'"'; } ?> required>
						</div>
